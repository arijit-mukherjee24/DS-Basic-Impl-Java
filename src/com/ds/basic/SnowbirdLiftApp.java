...
/* Output:
5
Lift has Mary and Anna on it: true
2nd chair has: Samantha, Kelly
John, Dave
Samantha, Kelly
Mary, Anna
Robert, Chad
Sarah, Bill
Can't unload any more skiers because the lift is empty: Can't deque because the queue is empty
*/